...
classdef adPtychoX_base < deep.DifferentiableFunction
    ...
    methods
        ...
        function initBuffers(self, sample_size, probe_size, batch_size)
            ...
            self.cuFFThandle_many = init_ptyX_base_buffers( ...
                int32(sample_size), int32(probe_size), int32(batch_size));
            self.latentW_buffer = init_ptyX_base_buffers( ...
                int32(sample_size), int32(probe_size), int32(batch_size), int32(1));
            self.latentZ_buffer = init_ptyX_base_buffers( ...
                int32(sample_size), int32(probe_size), int32(batch_size), int32(2));
        end
