...
disp("Building MATLAB extension for PtychoX with Near-field Ptychography");
...
mexcuda(flags{:}, 'scripts\buffer\init_ptyX_nearf_buffers.cu', '-outdir', [output_path, '\private']);
mexcuda(flags{:}, 'scripts\buffer\delete_ptyX_nearf_buffers.cu', '-outdir', [output_path, '\private']);
