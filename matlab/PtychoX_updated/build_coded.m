...
replace_file = {'fwd_adPtychoX_coded.cu', 'bwd_adPtychoX_coded.cu'};
output_path = '@adPtychoX_coded';
...
mexcuda(flags{:}, 'scripts\buffer\init_ptyX_coded_buffers.cu', '-outdir', [output_path, '\private']);
mexcuda(flags{:}, 'scripts\buffer\delete_ptyX_coded_buffers.cu', '-outdir', [output_path, '\private']);
