...
#ifndef MX_GPUARRAY_PUBLISHED_API_H
#define MX_GPUARRAY_PUBLISHED_API_H

#ifndef MX_GPUARRAY_API
#  define MX_GPUARRAY_API
#endif
 ...
 */
EXTERN_C MX_GPUARRAY_API int                mxInitGPU(void);

/**
 * @brief Return non-zero if the input mxArray contains GPU data.
 */
EXTERN_C MX_GPUARRAY_API int                mxIsGPUArray(mxArray const * const in);
 ...
 */
EXTERN_C MX_GPUARRAY_API mxGPUArray const * mxGPUCreateFromMxArray(mxArray const * const in);
 ...
 * mxGPUDestroyGPUArray on the result when you are done.
 */
EXTERN_C MX_GPUARRAY_API mxGPUArray *       mxGPUCopyFromMxArray(mxArray const * const in);
 ...
 * mxGPUDestroyGPUArray on the result when you are done.
 */
EXTERN_C MX_GPUARRAY_API mxGPUArray *       mxGPUCreateGPUArray(mwSize const ndims,
                                                                mwSize const *dims,
 ...
 */
EXTERN_C MX_GPUARRAY_API mxClassID          mxGPUGetClassID(mxGPUArray const * in);

/**
 * @brief Return the complexity of the data on the GPU.
 */

EXTERN_C MX_GPUARRAY_API mxComplexity       mxGPUGetComplexity(mxGPUArray const * in);

/**
 * @brief Returns true if the GPU data is sparse.
 */
EXTERN_C MX_GPUARRAY_API bool               mxGPUIsSparse(mxGPUArray const * in);
 ...
 */
EXTERN_C MX_GPUARRAY_API void *             mxGPUGetData(mxGPUArray * const in);
 ...
 * array has the appropriate type.
 */
EXTERN_C MX_GPUARRAY_API void const *       mxGPUGetDataReadOnly(mxGPUArray const * const in);

/**
 * @brief Return an array of dimensions.
 * @returns A pointer to an array of mwSize that must be deleted using mxFree.
 */
EXTERN_C MX_GPUARRAY_API mwSize const *     mxGPUGetDimensions(mxGPUArray const * const in);

/**
 * @brief Change the dimensions of this gpuArray without reallocating the memory.
 * Note that the new dimensions must not try to increase the overall size of the
 * array.
 */
EXTERN_C MX_GPUARRAY_API void               mxGPUSetDimensions(mxGPUArray * const pa, mwSize const * const size, mwSize const ndims);

/**
 * @brief Return the size of the dimension array for this array.
 */
EXTERN_C MX_GPUARRAY_API mwSize             mxGPUGetNumberOfDimensions(mxGPUArray const * const in);

/**
 * @brief Return the total number of elements on the GPU for this array.
 */
EXTERN_C MX_GPUARRAY_API mwSize             mxGPUGetNumberOfElements(mxGPUArray const * const in);
 ...
 */
EXTERN_C MX_GPUARRAY_API mxArray *          mxGPUCreateMxArrayOnGPU(mxGPUArray const * const in);
 ...
 * be destroyed.
 */
EXTERN_C MX_GPUARRAY_API mxArray *          mxGPUCreateMxArrayOnCPU(mxGPUArray const * const in);
 ...
 */
EXTERN_C MX_GPUARRAY_API void               mxGPUDestroyGPUArray(mxGPUArray const * const in);
 ...
 * done with it.
 */
EXTERN_C MX_GPUARRAY_API mxGPUArray *       mxGPUCopyGPUArray(mxGPUArray const * const in);
 ...
 */
EXTERN_C MX_GPUARRAY_API mxGPUArray *       mxGPUCopyReal(mxGPUArray const * const in);
 ...
 */
EXTERN_C MX_GPUARRAY_API mxGPUArray *       mxGPUCopyImag(mxGPUArray const * const in);
 ...
 */
EXTERN_C MX_GPUARRAY_API mxGPUArray *       mxGPUCreateComplexGPUArray(mxGPUArray const * const realPart,
                                                                       mxGPUArray const * const imagPart);

/**
 * @brief Returns non-zero if two mxGPUArrays refer to the same GPU data.
 */
EXTERN_C MX_GPUARRAY_API int                mxGPUIsSame(mxGPUArray const * const in1,
 ...
 */
EXTERN_C MX_GPUARRAY_API int                mxGPUIsValidGPUData(mxArray const * const in);
